...
public record CreateTaskCommand(MilestoneItemName Name, Description Description, DateRange DateRange, MilestoneId MilestoneId, Specialty Specialty, TaskStatus? Status, PersonId? PersonId, Money Money);